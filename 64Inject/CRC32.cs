...
namespace _64Inject
{
    public static class CRC32
    {
        ...
        public static uint Compute(byte[] source, int offset, int count, uint crc)
        {
        ...
        public static uint Compute(byte[] source, int offset, int count)
        {
            return Compute(source, offset, count, 0xFFFFFFFFU);
        }
        
        public static uint Compute(Stream source)
        {
